<%@ Page Language="C#" MasterPageFile="~/ADMINMASTER.master" AutoEventWireup="true" CodeFile="VIEW STUDENT MARKS BY ADMIN.aspx.cs" Inherits="VIEW_STUDENT_MARKS_BY_ADMIN" Title="VIEW STUDENT MARKS BY ADMIN" %>
    ...
    <tr>
        <td style="text-align: center">
            <asp:Label ID="Label27" runat="server" Font-Bold="True" Font-Size="XX-Large" 
                Text="STUDENT EXAMINATION DETAILS" ForeColor="#006600"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <asp:Panel ID="pnl1" runat="server">
                <table class="style1">
                    ...
                    <tr>
                        <td class="style2">
                            <asp:Label ID="Label25" runat="server" Font-Bold="True" Text="DEPARTMENT"></asp:Label>
                        </td>
                        <td class="style3">
                    ...
                    <tr>
                        <td class="style2">
                            <asp:Label ID="Label26" runat="server" Font-Bold="True" Text="YEAR/SEMESTER"></asp:Label>
                        </td>
                        <td class="style3">
