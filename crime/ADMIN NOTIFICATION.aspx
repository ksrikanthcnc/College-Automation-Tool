<%@ Page Language="C#" MasterPageFile="~/ADMINMASTER.master" AutoEventWireup="true" CodeFile="ADMIN NOTIFICATION.aspx.cs" Inherits="ADMIN_NOTIFICATION" Title="ADMIN NOTIFICATION" %>
    ...
    <tr>
        ...
        <td class="style7">
            <asp:Button ID="btnpost" runat="server" Font-Bold="True" Text="POST" 
                Width="100px" onclick="btnpost_Click" />
        </td>
        <td class="style8">
            &nbsp;</td>
        <td class="style9">
            <asp:Button ID="btncancel" runat="server" Font-Bold="True" Text="CANCEL" 
                Width="103px" onclick="btncancel_Click" />
        </td>
        <td>
            &nbsp;</td>
        <td>
