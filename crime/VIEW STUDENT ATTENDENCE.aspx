<%@ Page Language="C#" MasterPageFile="~/STUDENT.master" AutoEventWireup="true" CodeFile="VIEW STUDENT ATTENDENCE.aspx.cs" Inherits="VIEW_STUDENT_ATTENDENCE" Title="VIEW STUDENT ATTENDENCE" %>
    ...
    <tr>
        <td class="style6">
            <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Size="XX-Large" 
                Text="STUDENT ATTENDENCE" ForeColor="#329203"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <asp:Panel ID="pnl1" runat="server">
                <table class="style1">
                    ...
                    <tr>
                        <td class="style10">
                            <asp:Label ID="Label20" runat="server" Font-Bold="True" Text="DEPARTMENT"></asp:Label>
                        </td>
                        <td class="style9">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnsbmt" runat="server" Font-Bold="True" Font-Size="Medium" 
                                Text="SUBMIT" Width="88px" onclick="btnsbmt_Click" />
                        </td>
                    </tr>
                    <tr>
        ...
        <td>
            <asp:Panel ID="pnl31" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSource11" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [THREEONEYEARSTUDENTATTENDENCE] WHERE ([YEAR] = @YEAR2)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlyear" Name="YEAR2" 
                            PropertyName="SelectedValue" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
