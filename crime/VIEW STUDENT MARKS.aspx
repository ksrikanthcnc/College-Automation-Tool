<%@ Page Language="C#" MasterPageFile="~/STUDENT.master" AutoEventWireup="true" CodeFile="VIEW STUDENT MARKS.aspx.cs" Inherits="VIEW_STUDENT_MARKS" Title="VIEW STUDENT MARKS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td style="text-align: center">
            <asp:Label ID="Label22" runat="server" Font-Bold="True" Font-Size="XX-Large" 
                Text="MARKS" ForeColor="Red"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Panel ID="Panel3" runat="server">
                <table class="style1">
                    ...
                    <tr>
                        <td class="style6">
                            <asp:Label ID="Label23" runat="server" Font-Bold="True" Text="DEPARTMENT"></asp:Label>
                        </td>
                        <td class="style7">
                    ...
                    <tr>
                        <td class="style6">
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Text="YEAR/SEMESTER"></asp:Label>
                        </td>
                        <td class="style7">
                        ...
                        <td>
                            <asp:Button ID="btnsbmt" runat="server" Font-Bold="True" 
                                onclick="btnsbmt_Click" Text="SUBMIT" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
        ...
        <td>
            <asp:Panel ID="pnl21" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CollegeAutomationToolConnectionString %>" 
                    SelectCommand="SELECT * FROM [TWOONEYEARSTUDENTEXAMINATIONDETAILS]">
                </asp:SqlDataSource>
            </asp:Panel>
        </td>
    </tr>
        ...
        <td>
            <asp:Panel ID="pnl22" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CollegeAutomationToolConnectionString %>" 
                    SelectCommand="SELECT * FROM [TWOTWOYEARSTUDENTEXAMINATIONDETAILS]">
                </asp:SqlDataSource>
            </asp:Panel>
        </td>
    </tr>
        ...
        <td>
            <asp:Panel ID="pnl31" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CollegeAutomationToolConnectionString %>" 
                    SelectCommand="SELECT * FROM [THREEONEYEARSTUDENTEXAMINATIONDETAILS]">
                </asp:SqlDataSource>
            </asp:Panel>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <asp:Panel ID="pnl32" runat="server" style="margin-top: 26px">
                ...
                <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CollegeAutomationToolConnectionString %>" 
                    SelectCommand="SELECT * FROM [THREETWOYEARSSTUDENTEXAMINATIONDETAILS]">
                </asp:SqlDataSource>
            </asp:Panel>
        </td>
    </tr>
        ...
        <td>
            <asp:Panel ID="pnl41" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CollegeAutomationToolConnectionString %>" 
                    SelectCommand="SELECT * FROM [FOURONEYEARSSTUDENTEXAMINATIONDETAILS]">
                </asp:SqlDataSource>
            </asp:Panel>
        </td>
    </tr>
        ...
        <td>
            <asp:Panel ID="pnl42" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSource7" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CollegeAutomationToolConnectionString %>" 
                    SelectCommand="SELECT * FROM [FOURTWOYEARSTUDENTEXAMINATIONDETAILS]">
                </asp:SqlDataSource>
            </asp:Panel>
        </td>
    </tr>
