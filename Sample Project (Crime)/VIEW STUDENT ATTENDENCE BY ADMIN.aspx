<%@ Page Language="C#" MasterPageFile="~/ADMINMASTER.master" AutoEventWireup="true" CodeFile="VIEW STUDENT ATTENDENCE BY ADMIN.aspx.cs" Inherits="VIEW_STUDENT_ATTENDENCE_BY_ADMIN" Title="VIEW STUDENT ATTENDENCE BY ADMIN" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnsbmt" runat="server" Font-Bold="True" Text="SUBMIT" 
                                Width="101px" onclick="btnsbmt_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
